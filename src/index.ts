...
import userRouter from "./routes/usersRoutes.js"; // Import user routes
...
app.use("/api/v2/users", userRouter); // Use user routes
app.use("/api/v2/enrollments", enrollmentsRouter); // Use enrollments routes
